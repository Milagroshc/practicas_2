...
class EstadisticaControlador
{
    ...
    )
    {
        ...
        public  function guardarIndicador(Request $request, Response $response, $args) {
            try {
                //var_dump($filename);
                ...
                $idIndicador = Indicador::insertGetId($indicador);
            ...
            public function guardarRegistroIndicador(Request $request, Response $response, $args) {
                ...
                try {
                   ...
                   // var_dump(get_object_vars($uploadedFile));
                    ...
                    //EstadisticaControlador::uploadIndicadores($datinos); //se generará un enlace con datin
 ...
 */
            ...
            if(0<$t){
            EstadisticaControlador::crearExcelTablaHTML($registrosIndicador);
            }else{
...
$spreadsheet->getActiveSheet()->getStyle('A1:G1')->setConditionalStyles($conditionalStyles);
	...
	public function guardarTematica(Request $request, Response $response, $args) {
	    ...
	    try {
	        /*recibo los parametros del login*/
	        $directory= Constante::REPOSITORIO_FILE."estadistica/";
            

            $uploadedFiles = $request->getUploadedFiles();
               
                $archivos =Array("archivo", "banner");
                ...
                for ($i=0; $i < count($archivos) ; $i++) { 
                    ...
                    // var_dump(get_object_vars($uploadedFile));
                        ...
                        $docAdjunto=[
                            "nombre"=>$uploadedFile->getClientFilename(),
                            "urlAdjunto"=>Constante::DOMAINSITE."uploads/estadistica/".$filename,
                            "tamanio"=>$uploadedFile->getSize(),
                            "formato"=>$uploadedFile->getClientMediaType(),
                            "estado"=>1
                        ];
	        ...
	        $tematica=[
                ...
                "token_url"=>$this->hash->hash($ruta),
	            "estado"=>0,
                "idDocAdjunto"=>$idDocAdjuntos[0]["idDocAdjunto"],
                "banner"=>$idDocAdjuntos[1]["idDocAdjunto"]
	        ];
...
/* Estadiastica EMMSA 21012020 */
public function estadisticaVolumenPrecios(Request $request, Response $response, $args)
{
    try {
      ...
      $datin["mensaje"]= $mensaje;
      $datin["success"] = $estado;
      $datin["contenido"] = "contenido de prueba";
      $datin["parametros"] = ['title'=>"Publicaciones :: emmsa", 'titulo' => "Publicaciones Ambientales", 'banner'=> "uploads/1bb2031811bdbd10.jpg" ];
      //$obj1 = JsonRenderer::render($response,200,$datin);
      //var_dump($datin);
      //exit;
      $this->view->render($response, "emmsa/estadistica/volumen-precio.twig", $datin);
      return $response;
}

public function estadisticaHistoricoVolumen(Request $request, Response $response, $args)
{
    try {
        $datin["anios"]= ReporteTiempoLugarVolumen::getDistinctAnios();
        //extraer data de los indicadores del agua
        //$datin["meses"] = Parametros::getParametros(3);
        $mensaje ="se listo correctamente los indicadores";
        $estado = true;
      ...
      $datin["success"] = $estado;
      $datin["contenido"] = "contenido de prueba";
      $datin["parametros"] = ['title'=>"Publicaciones :: emmsa", 'titulo' => "Historico Volumen", 'banner'=> "uploads/1bb2031811bdbd10.jpg" ];
      //$obj1 = JsonRenderer::render($response,200,$datin);
      //var_dump($datin);
      //exit;
      $this->view->render($response, "emmsa/estadistica/historico-volumen.twig", $datin);
      return $response;
}

public function estadisticaProcedencia(Request $request, Response $response, $args)
{
    try {
        $datin["anios"]= ReporteTiempoLugarVolumen::getDistinctAnios();
        //extraer data de los indicadores del agua
      ...
      $datin["success"] = $estado;
      $datin["contenido"] = "contenido de prueba";
      $datin["parametros"] = ['title'=>"Publicaciones :: emmsa", 'titulo' => "Estadistica por Procedencia", 'banner'=> "uploads/1bb2031811bdbd10.jpg" ];
      //$obj1 = JsonRenderer::render($response,200,$datin);
      //var_dump($datin);
      //exit;
      $this->view->render($response, "emmsa/estadistica/procedencia.twig", $datin);
      return $response;
}

public function estadisticaVariacionProcedencia(Request $request, Response $response, $args)
{
    
    try {
        $datin["anios"]= ReporteTiempoLugarVolumen::getDistinctAnios();

        $datin["productos"]= ReporteTiempoLugarVolumen::getDistinctProductos();
        //extraer data de los indicadores del agua
        //$datin["meses"] = Parametros::getParametros(3);
        $mensaje ="se listo correctamente los indicadores";
        $estado = true;
      ...
      $datin["success"] = $estado;
      $datin["contenido"] = "contenido de prueba";
      $datin["parametros"] = ['title'=>"Publicaciones :: emmsa", 'titulo' => "Estadistica de Productos por Procedencia", 'banner'=> "uploads/1bb2031811bdbd10.jpg" ];
      //$obj1 = JsonRenderer::render($response,200,$datin);
      //var_dump($datin);
      //exit;
      $this->view->render($response, "emmsa/estadistica/variacion-procedencia.twig", $datin);
      return $response;
}
